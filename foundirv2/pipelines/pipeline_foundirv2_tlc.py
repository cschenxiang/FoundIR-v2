...
from .pipeline_output import foundirv2StableDiffusionXLPipelineOutput
import PIL.Image
...
class foundirv2StableDiffusionXLPipeline(
    DiffusionPipeline,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        return foundirv2StableDiffusionXLPipelineOutput(images=image)
